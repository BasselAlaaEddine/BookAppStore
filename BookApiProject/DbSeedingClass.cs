            ...
            var booksAuthors = new List<BookAuthor>()
            {
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        DatePublished=new DateTime(1850,4,5),
                        BookCategories=new List<BookCategory>()
                        {
                            new BookCategory(){Category=new Category(){Name="science fiction"}}
                        },
                        Reviews = new List<Review>()
                        {
                            new Review(){ HeadLine = "Elna7o", ReviewText = "This book made me cry a few times", Rating = 5,
                             Reviewer = new Reviewer(){ FirstName = "Adel", LastName = "Shakal"}
                            }
